...
export default function Step1Connect({ styles, onConnect, onSkip }) {
  return (
    <div className="w-100 animate-fade-in">
      ...
      <div className="border border-light-subtle rounded-4 p-4 p-md-5 text-center bg-white shadow-sm mx-auto" style={{ maxWidth: '520px' }}>
        <div className="d-flex align-items-center justify-content-center bg-light rounded-3 mb-4 mx-auto" style={{ width: '64px', height: '64px', color: '#6c757d' }}>
        ...
        <div className="d-flex flex-column flex-sm-row gap-3 justify-content-center mb-4">
          <CTAButton variant="primary" size="medium" onClick={onConnect}>
            Connect Github account
          </CTAButton>
          <CTAButton variant="outline" size="medium" onClick={onSkip}>
            Skip for now
          </CTAButton>
        </div>
