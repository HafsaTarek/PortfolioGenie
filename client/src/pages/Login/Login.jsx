      ...
      <div className="dev bg-white d-flex justify-content-center align-content-center">
        <div className={`${styles.containery} m-auto mt-5 w-75 rounded-4`}>
          ...
          <form className="w-75 mx-auto">
            ...
            <button type="submit" variant="primary" className={`${styles.btn_1, styles.button_main_color} text-white w-100 py-3 border-0 rounded-2 fw-bold`}>Login</button>
          </form>
          <div className="login-navigate d-flex justify-content-center my-5">
            <h4 color="mt-2">Don't have an account?</h4>
            <button className={`${styles.mainColor} border-0 fw-bold ps-2 pb-2 bg-transparent`} onClick={() => navigate('/register')}>Sign up for free</button>
          </div>
        </div>
      </div>
